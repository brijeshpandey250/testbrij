<template>
  ...
  <div class="banner_w3lspvt" id="home">
	  <div class="csslider infinity" id="slider1">
		  <input type="radio" name="slides" checked id="slides_1"/>
		  ...
		  <h3 class="heading text-center mb-3 mb-sm-5">Services</h3>
			  <div class="row ab-info">
				  <div class="col-md-6 ab-content ab-content1">
					  <div class="ab-content-inner">
						  <router-link to="/"><img src="../assets/images/services2.jpg" alt="news image" class="img-fluid"></router-link>
						  <div class="ab-info-con">
							  <h4> Trim your Hair</h4>
							  <router-link to="/" class="read-more two btn m-0 px-3"><span class="fa fa-arrow-circle-o-right"> </span></router-link>
						  </div>
					  </div>
				  </div>
				  <div class="col-md-6 ab-content ab-content1">
			  ...
			  <div class="row ab-info second mt-lg-4">
				  <div class="col-md-3 ab-content">
					  <div class="ab-content-inner">
						<router-link to="/"><img src="../assets/images/ser3.jpg" alt="news image" class="img-fluid"></router-link>
						  <div class="ab-info-con">
							  <h4>colouring</h4>
							  <router-link to="/" class="read-more two btn m-0 px-3"><span class="fa fa-arrow-circle-o-right"> </span></router-link>
						  </div>
		  ...
		  <div class="container py-md-5">
			  <div class="test-info text-center">
				  ...
				  <div class="read-more mx-auto m-0 text-center">
					<router-link to="/" class="read-more scroll btn">Click here</router-link>
				  </div>
			  </div>
		  </div>
	  </section>
